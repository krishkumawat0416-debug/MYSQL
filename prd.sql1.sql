...
select prd.pid , prd.pname, ord.productid, ord.city from product as prd
join orders as ord
where prd.pid = ord.productid;

-- orderid is primary key, productid is foreign key that refer to primary key of product tbale(pid)--
select * from orders;
